...
\end{defi}
\begin{dem}
$\Rightarrow)$ $\bgamma \vdash \varphi \implies \bgamma \cup \pset{\lnot\varphi}$ es inconsistente entonces $\varphi \in \bgamma$. \\
\noindent $\Leftarrow)$ Si $\varphi \in \bgamma $ entonces $\bgamma \vdash \varphi$ por definición. 
\end{dem}

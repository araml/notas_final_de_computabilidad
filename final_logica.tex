...
\newenvironment{solution}[0]{\textbf{Solución:}  \begin{adjustwidth}{1.5em}{1.5em}}{\end{adjustwidth}}
\newenvironment{teo}[1]{\refstepcounter{thm}\noindent\textbf{Teorema~\thethm \,  (#1):} }{}
\newenvironment{dem}[0]{\refstepcounter{thm}\noindent\textbf{Demostración:} }{}
...
Una solución alternativa corta, como un modelo estandar de la aritmética tiene un modelo infinito, por Löwenheim-Skolem tiene modelos de cardinalidad arbitraria ($\geq \aleph_0$) entonces un modelo no numerable de los naturales no puede ser estandar.
